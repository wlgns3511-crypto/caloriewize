  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <nav className="not-prose text-sm text-slate-500 mb-4">
        ...
        <Link href="/guide/" className="hover:text-orange-700">Guides</Link>
        <span className="mx-2">&rsaquo;</span>
      ...
      <TrustBlock sources={[{name:"USDA FoodData Central",url:"https://fdc.nal.usda.gov/"},{name:"FDA Daily Values",url:"https://www.fda.gov/food/nutrition-facts-label/daily-value-nutrition-and-supplement-facts-labels"}]} updated="Current USDA FDC release" />
      ...
      <nav aria-label="Table of contents" className="not-prose my-6 p-4 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <ol className="space-y-1.5 text-sm">
          {guide.sections.map((s, i) => (
            <li key={i}>
              <a href={`#section-${i}`} className="text-orange-700 hover:underline">{s.heading}</a>
            </li>
          ))}
          <li><a href="#faq" className="text-orange-700 hover:underline">Frequently Asked Questions</a></li>
        </ol>
      </nav>
