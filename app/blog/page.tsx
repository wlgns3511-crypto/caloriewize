...
export const metadata: Metadata = {
  title: "Nutrition & Calorie Guides",
  description:
  ...
  return (
    <>
      <h1 className="text-3xl font-bold text-slate-900 mb-2">
        Nutrition &amp; Calorie Guides
      </h1>
      <p className="text-slate-600 mb-8">
        Expert articles on calorie counting, nutrition science, and food data to
        help you make smarter eating decisions every day.
      </p>
