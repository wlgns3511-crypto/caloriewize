...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with the CalorieWize team.",
};
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mt-6">
        ...
        <p className="mb-2">
          <strong>Email:</strong>{" "}
          <a href="mailto:contact@caloriewize.com" className="text-orange-600 hover:underline">
            contact@caloriewize.com
          </a>
        </p>
      ...
      <p>
        Your feedback helps us improve CalorieWize for everyone. If you notice any data discrepancies or have ideas
        for new features, please let us know.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-3">Data Corrections</h2>
      <p>
        All our nutrition data comes from USDA FoodData Central. If you believe there is an error in the data
