...
export const metadata: Metadata = {
  ...
  description: "Learn how FoodDataPeek collects, processes, and verifies nutritional information for common foods.",
};
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p className="lead text-lg text-slate-600">
        FoodDataPeek is committed to providing accurate, comprehensive, and up-to-date data.
        This page explains how we collect, process, and verify our information.
      </p>

      <h2>Data Sources</h2>
      <p>
        Our data is sourced from authoritative, publicly available databases including: <strong>USDA FoodData Central API</strong>.
      ...
      <ul>
        <li><a href="https://fdc.nal.usda.gov/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">USDA FoodData Central</a></li>
      </ul>
    </article>
  );
}
