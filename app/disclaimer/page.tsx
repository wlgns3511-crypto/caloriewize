...
export const metadata: Metadata = {
  title: "Disclaimer",
  description: "Disclaimer and limitations of liability for CalorieWize.",
...
export default function DisclaimerPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p>
        The information provided on CalorieWize is for general informational and educational purposes only. While we
      ...
      <p>
        Data displayed on CalorieWize is sourced from publicly available databases and third-party sources. While we
      ...
      <p>
        CalorieWize displays third-party advertisements through Google AdSense and other ad networks. These advertisements
        are provided by third parties and do not imply endorsement by CalorieWize. We are not responsible for the content
